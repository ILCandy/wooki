    ...
    var menuVal = [
            {
                ...
                "url": "/admin/temp/report.html",
                "text": "报表查询"
            },
            {
                "icon": "list-icon-manage",
                "url": "/admin/temp/manage.html",
                "text": "设备管控"
            },
            {
                "icon": "list-icon-scene",
                "url": "/admin/temp/scene.html",
                "text": "情景模式"
            },
            {
                "icon": "list-icon-linkage",
                "url": "/admin/temp/linkage.html",
                "text": "联动模式"
            },
            {
                "icon": "list-icon-office",
                "url": "/admin/temp/office.html",
                "text": "办公设置"
            },
            {
                "icon": "list-icon-systemLogs",
                "url": "/admin/temp/systemLogs.html",
                "text": "设备日志"
            },
            {
                "icon": "list-icon-notices",
                "url": "/admin/temp/notices.html",
                "text": "新闻公告"
            },
            {
                "icon": "list-icon-meeting",
                "url": "/admin/temp/meeting.html",
                "text": "会议室申请"
            },
            {
                "icon": "list-icon-workac",
                "url": "/admin/temp/workac.html",
                "text": "加班空调分配"
            },
            {
                "icon": "list-icon-workacBooking",
                "url": "/admin/temp/workacBooking.html",
                "text": "空调申请"
            },
            {
                "icon": "list-icon-workacList",
                "url": "/admin/temp/workacList.html",
                "text": "空调申请记录"
            },
            {
                "icon": "list-icon-chargeTable",
                "url": "/admin/temp/chargeTable.html",
                "text": "计费结算"
            }
        ];
